using MultiTierProject.Core.Intefaceses.Integration;
...
namespace MultiTierProject.Integration.ClientServiceses
{
    public abstract class GenericClientService<TEntity> : IMultiTierProjectClient<TEntity> where TEntity : class
    {
